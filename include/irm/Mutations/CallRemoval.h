...
template <bool onlyIntrinsics> class CallRemoval : public IRMutation {
public:
...
typedef CallRemoval<false> RemoveVoidFunctionCall;
typedef CallRemoval<true> RemoveVoidIntrinsicCall;
