...
TEST(CallReplacement, canMutate) {
  ...
  auto function = llvm::Function::Create(functionType, linkage, "test", module);
  ...
  auto intFunction = llvm::Function::Create(intFunctionType, linkage, "call_int", module);

  auto floatType = llvm::Type::getFloatTy(context);
  auto floatFunctionType = llvm::FunctionType::get(floatType, false);
  auto floatFunction = llvm::Function::Create(floatFunctionType, linkage, "call_float", module);
